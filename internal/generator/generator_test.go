...
var testCases = []struct {
	...
	},
	{
		...
		assertFunc: func(t *testing.T, generatedCode []byte, stubCode []byte) {
			...
			assertContainsPattern(t, generatedStr, `func ConvertUserVVsSourceToUserVVsTarget\(froms UsersVVSource\) UsersVVTarget`)
			...
			assertContainsPattern(t, generatedStr, `func ConvertUserPPsSourceToUserPPsTarget\(froms UsersPPSource\) UsersPPTarget`)
			...
			assertContainsPattern(t, generatedStr, `Users:\s+ConvertUserVPsSourceToUserVPTarget\(from.Users\),`)
			assertContainsPattern(t, generatedStr, `func ConvertUserVPsSourceToUserVPTarget\(froms UsersVPSource\) UsersVPTarget`)
			...
			assertContainsPattern(t, generatedStr, `Users:\s+ConvertUserPPPsSourceToUserPPPTarget\(from.Users\),`)
			assertContainsPattern(t, generatedStr, `func ConvertUserPPPsSourceToUserPPPTarget\(froms UsersPPPSource\) UsersPPPTarget`)
			assertContainsPattern(t, generatedStr, `for i, f := range \(\*from\)`)
			assertContainsPattern(t, generatedStr, `return &tos`)
			...
			assertContainsPattern(t, generatedStr, `func ConvertUserPV2sSourceToUserPV2sTarget\(froms UsersPV2Source\) UsersPV2Target`)
