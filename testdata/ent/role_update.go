...
func (_u *RoleUpdate) SetStatus(v int) *RoleUpdate {
...
func (_u *RoleUpdate) SetNillableStatus(v *int) *RoleUpdate {
	if v != nil {
		_u.SetStatus(*v)
	}
	return _u
...
func (_u *RoleUpdate) AddStatus(v int) *RoleUpdate {
...
// SetStatus sets the "status" field.
func (_u *RoleUpdateOne) SetStatus(v int) *RoleUpdateOne {
	_u.mutation.ResetStatus()
	_u.mutation.SetStatus(v)
	return _u
}
...
// SetNillableStatus sets the "status" field if the given value is not nil.
func (_u *RoleUpdateOne) SetNillableStatus(v *int) *RoleUpdateOne {
	if v != nil {
		_u.SetStatus(*v)
	}
	return _u
...
// AddStatus adds value to the "status" field.
func (_u *RoleUpdateOne) AddStatus(v int) *RoleUpdateOne {
	_u.mutation.AddStatus(v)
	return _u
}
