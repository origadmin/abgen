...
func (_c *UserPositionCreate) SetUserID(v string) *UserPositionCreate {
	_c.mutation.SetUserID(v)
	return _c
}

// SetPositionID sets the "position_id" field.
func (_c *UserPositionCreate) SetPositionID(v string) *UserPositionCreate {
	_c.mutation.SetPositionID(v)
	return _c
}

// SetID sets the "id" field.
func (_c *UserPositionCreate) SetID(v string) *UserPositionCreate {
	_c.mutation.SetID(v)
	return _c
}
...
func (_c *UserPositionCreate) sqlSave(ctx context.Context) (*UserPosition, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected UserPosition.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *UserPositionCreate) createSpec() (*UserPosition, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(userposition.Table, sqlgraph.NewFieldSpec(userposition.FieldID, field.TypeString))
	)
