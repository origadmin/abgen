...
func (_c *UserDepartmentCreate) SetUserID(v string) *UserDepartmentCreate {
	_c.mutation.SetUserID(v)
	return _c
}

// SetDepartmentID sets the "department_id" field.
func (_c *UserDepartmentCreate) SetDepartmentID(v string) *UserDepartmentCreate {
	_c.mutation.SetDepartmentID(v)
	return _c
}

// SetID sets the "id" field.
func (_c *UserDepartmentCreate) SetID(v string) *UserDepartmentCreate {
	_c.mutation.SetID(v)
	return _c
}
