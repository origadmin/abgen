...
func (_q *PositionPermissionQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *PositionPermissionQuery) FirstIDX(ctx context.Context) string {
...
func (_q *PositionPermissionQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *PositionPermissionQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *PositionPermissionQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *PositionPermissionQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PositionPermissionQuery) loadPosition(ctx context.Context, query *PositionQuery, nodes []*PositionPermission, init func(*PositionPermission), assign func(*PositionPermission, *Position)) error {
	...
	nodeids := make(map[string][]*PositionPermission)
	for i := range nodes {
...
func (_q *PositionPermissionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(positionpermission.Table, positionpermission.Columns, sqlgraph.NewFieldSpec(positionpermission.FieldID, field.TypeString))
	_spec.From = _q.sql
