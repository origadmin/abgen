...
import (
	...
	"github.com/origadmin/abgen/testdata/ent/migrate"
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.Position, c.PositionPermission, c.Resource, c.Role, c.RolePermission,
		c.SoftDelete, c.User, c.UserDepartment, c.UserPosition, c.UserRole,
	} {
		n.Use(hooks...)
	}
}
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	case *SoftDeleteMutation:
		return c.SoftDelete.mutate(ctx, m)
	case *UserMutation:
...
// UpdateOneID returns an update builder for the given id.
func (c *PermissionResourceClient) UpdateOneID(id string) *PermissionResourceUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *PermissionResourceClient) DeleteOneID(id string) *PermissionResourceDeleteOne {
...
func (c *PermissionResourceClient) Get(ctx context.Context, id string) (*PermissionResource, error) {
	return c.Query().Where(permissionresource.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *PermissionResourceClient) GetX(ctx context.Context, id string) *PermissionResource {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// UpdateOneID returns an update builder for the given id.
func (c *PositionPermissionClient) UpdateOneID(id string) *PositionPermissionUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *PositionPermissionClient) DeleteOneID(id string) *PositionPermissionDeleteOne {
...
func (c *PositionPermissionClient) Get(ctx context.Context, id string) (*PositionPermission, error) {
	return c.Query().Where(positionpermission.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *PositionPermissionClient) GetX(ctx context.Context, id string) *PositionPermission {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `softdelete.Intercept(f(g(h())))`.
func (c *SoftDeleteClient) Intercept(interceptors ...Interceptor) {
	c.inters.SoftDelete = append(c.inters.SoftDelete, interceptors...)
}

// Create returns a builder for creating a SoftDelete entity.
...
// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *SoftDeleteClient) MapCreateBulk(slice any, setFunc func(*SoftDeleteCreate, int)) *SoftDeleteCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &SoftDeleteCreateBulk{err: fmt.Errorf("calling to SoftDeleteClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*SoftDeleteCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
		setFunc(builders[i], i)
	}
...
// UpdateOne returns an update builder for the given entity.
func (c *SoftDeleteClient) UpdateOne(_m *SoftDelete) *SoftDeleteUpdateOne {
	mutation := newSoftDeleteMutation(c.config, OpUpdateOne, withSoftDelete(_m))
...
// DeleteOne returns a builder for deleting the given entity.
func (c *SoftDeleteClient) DeleteOne(_m *SoftDelete) *SoftDeleteDeleteOne {
	return c.DeleteOneID(_m.ID)
}
...
func (c *SoftDeleteClient) Query() *SoftDeleteQuery {
	return &SoftDeleteQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeSoftDelete},
		inters: c.Interceptors(),
	}
}
...
func (c *SoftDeleteClient) Hooks() []Hook {
	return c.hooks.SoftDelete
}

// Interceptors returns the client interceptors.
func (c *SoftDeleteClient) Interceptors() []Interceptor {
	return c.inters.SoftDelete
}

func (c *SoftDeleteClient) mutate(ctx context.Context, m *SoftDeleteMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&SoftDeleteCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&SoftDeleteUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&SoftDeleteUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&SoftDeleteDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown SoftDelete mutation op: %q", m.Op())
	}
}
...
// UpdateOneID returns an update builder for the given id.
func (c *UserPositionClient) UpdateOneID(id string) *UserPositionUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *UserPositionClient) DeleteOneID(id string) *UserPositionDeleteOne {
...
func (c *UserPositionClient) Get(ctx context.Context, id string) (*UserPosition, error) {
	return c.Query().Where(userposition.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *UserPositionClient) GetX(ctx context.Context, id string) *UserPosition {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
type (
	hooks struct {
		...
		PositionPermission, Resource, Role, RolePermission, SoftDelete, User,
