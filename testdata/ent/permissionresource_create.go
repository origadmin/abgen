...
func (_c *PermissionResourceCreate) SetPermissionID(v string) *PermissionResourceCreate {
	_c.mutation.SetPermissionID(v)
	return _c
}

// SetResourceID sets the "resource_id" field.
func (_c *PermissionResourceCreate) SetResourceID(v string) *PermissionResourceCreate {
	_c.mutation.SetResourceID(v)
	return _c
}

// SetID sets the "id" field.
func (_c *PermissionResourceCreate) SetID(v string) *PermissionResourceCreate {
	_c.mutation.SetID(v)
	return _c
}
...
func (_c *PermissionResourceCreate) sqlSave(ctx context.Context) (*PermissionResource, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected PermissionResource.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *PermissionResourceCreate) createSpec() (*PermissionResource, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(permissionresource.Table, sqlgraph.NewFieldSpec(permissionresource.FieldID, field.TypeString))
	)
