...
func (_q *PermissionResourceQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *PermissionResourceQuery) FirstIDX(ctx context.Context) string {
...
func (_q *PermissionResourceQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *PermissionResourceQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *PermissionResourceQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *PermissionResourceQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PermissionResourceQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(permissionresource.Table, permissionresource.Columns, sqlgraph.NewFieldSpec(permissionresource.FieldID, field.TypeString))
	_spec.From = _q.sql
