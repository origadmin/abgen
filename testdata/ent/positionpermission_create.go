...
func (_c *PositionPermissionCreate) SetPositionID(v string) *PositionPermissionCreate {
	_c.mutation.SetPositionID(v)
	return _c
}

// SetPermissionID sets the "permission_id" field.
func (_c *PositionPermissionCreate) SetPermissionID(v string) *PositionPermissionCreate {
	_c.mutation.SetPermissionID(v)
	return _c
}

// SetID sets the "id" field.
func (_c *PositionPermissionCreate) SetID(v string) *PositionPermissionCreate {
	_c.mutation.SetID(v)
	return _c
}
...
func (_c *PositionPermissionCreate) sqlSave(ctx context.Context) (*PositionPermission, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(string); ok {
			...
			return nil, fmt.Errorf("unexpected PositionPermission.ID type: %T", _spec.ID.Value)
		}
	}
...
func (_c *PositionPermissionCreate) createSpec() (*PositionPermission, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(positionpermission.Table, sqlgraph.NewFieldSpec(positionpermission.FieldID, field.TypeString))
	)
