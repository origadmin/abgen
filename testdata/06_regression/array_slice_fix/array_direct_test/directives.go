...
//go:abgen:package:path=github.com/origadmin/abgen/testdata/03_advanced_features/slice_conversion_test_case/source,alias=source
//go:abgen:package:path=github.com/origadmin/abgen/testdata/03_advanced_features/slice_conversion_test_case/target,alias=target
